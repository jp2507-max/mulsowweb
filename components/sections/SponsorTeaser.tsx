...
export default function SponsorTeaser({ maxItems = 6, className = '' }: SponsorTeaserProps) {
  ...
  return (
    <section className={`py-16 md:py-20 bg-neutral-50 ${className}`}>
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-7xl">
        {/* Section Header */}
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold font-heading text-ink-primary mb-4">
            Unsere Partner
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 mb-12">
          {displaySponsors.map((sponsor, index) => (
            ...
            >
              <ExternalLink href={sponsor.url} className="block group">
                <Card className="h-full bg-white border border-neutral-200 hover:border-brand-light hover:shadow-xl hover:scale-105 transition-all duration-300 p-6 md:p-8 text-center">
                  ...
                  <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-4 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-lg flex items-center justify-center">
        ...
        <div className="text-center">
          <a
            href="/sponsoren"
            className="inline-flex items-center px-8 py-4 bg-brand-primary text-white font-semibold rounded-xl hover:bg-brand-secondary hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg hover:shadow-xl"
          >
